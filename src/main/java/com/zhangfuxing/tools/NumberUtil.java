...
public class NumberUtil {
    ...
    public static Double scale(Double eastCoor, int c) {
        if (eastCoor == null) return null;
        return new BigDecimal(eastCoor).setScale(c, RoundingMode.HALF_UP).doubleValue();
    }
}
